    ...
    await queryInterface.bulkInsert('NewsPosts', [
      ...
      },
      {
        ...
        contentVi:
          ...
          '<p><em>(Tiện ích cảnh quan đa dạng tại Tân Uyên Central Point.)</em></p>' +
          ...
          '<p><em>(Tân Uyên Central Point sở hữu tiện ích ngoại khu vượt trội.)</em></p>' +
        ...
        contentEn:
          ...
          '<p><em>(Diverse landscape amenities at Tan Uyen Central Point.)</em></p>' +
          ...
          '<p><em>(Tan Uyen Central Point offers outstanding off-site amenities.)</em></p>' +
      ...
      },
      {
        ...
        contentVi:
          ...
          '<p><em>Phối cảnh dự án Thăng Long House.</em></p>' +
        ...
        contentEn:
          ...
          '<p><em>Perspective rendering of the Thang Long House project.</em></p>' +
